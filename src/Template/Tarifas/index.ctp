                ...
                <tbody>
                    ...
                    <tr ng-show="tarifas.length == 0 && !loading && !restringido" style="background-color: #fff;" 
                        ...
                        <td colspan="7">
                            ...
                            <button id="btnRegistrarTarifa" ng-show="origen_selected != 0 && destino_selected != 0" type="button" class="btn btn-primary" ng-click="registerTarifa()">Registrar Tarifa</button>
                        </td>
                    </tr>
