...
<form ng-submit="saveProgramacion()">
    ...
    <button id="btnRegistrarProgramacion" type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> Registrar</button>
    <a href="#/programaciones" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-ban-circle"></span> Regresar</a>
</form>