<?php
    ...
    for ($i = 0; $i < 35; $i++) {
        ...
        $pdf->SetFont("Arial", "", 8);
        $pdf->Cell(160, $h_celda, utf8_decode('sobre'), $borde_celda, 0, 'L');
        $pdf->Cell(37, $h_celda, utf8_decode('15.00'), $borde_celda, 0, 'L');
    ...
    $pdf->Text($margen_x + 164, $margen_y + 71 + ($h_celda * 35), utf8_decode('150.00'));
