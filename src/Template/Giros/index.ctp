                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12" ng-show="dni_inserted === 'nombres'">
                                                    <input class="form-control" ng-model="newGiro.nombres_aux" type="search" style="width: 100%; display: inline;">
                                                </div>
                                            </div>
                                            <span ng-show="searching">Buscando</span>
                        ...
                        <table class="table" border="0" cellpadding="1" cellspacing="1" id="marco_panel">
                            ...
                            <tbody>
                                ...
                                <tr ng-show="!loading" ng-repeat="giro in (filteredGiros = (giros | orderBy:'codigo' | filter: filter_giros))"
                                    ...
                                    <td width="5%">{{ giro.desplazamiento.AgenciaOrigen.ubigeo.descripcion }} ({{ giro.desplazamiento.AgenciaOrigen.direccion }})</td>
                                    <td width="5%">{{ giro.desplazamiento.AgenciaDestino.ubigeo.descripcion }} ({{ giro.desplazamiento.AgenciaDestino.direccion }})</td>
...
<!-- Modal -->
<div class="modal fade" id="mdlPersonasGR" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<!-- Modal -->
<div class="modal fade" id="mdlPersonasGD" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
