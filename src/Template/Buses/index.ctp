...
<a id="btnAddBus" class="btn btn-primary" ng-click="addBus()"><span class="glyphicon glyphicon-plus"></span> Nuevo Bus</a>
                ...
                <tbody>
                    ...
                    <tr ng-show="!loading" ng-repeat="bus in buses | orderBy:predicate:reverse"
                        ...
                        <td width="4%">
                            ...
                            <a style="cursor: pointer;" href="#/busesAdministrar/{{bus.id}}"  title="administrar"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span></a> |
